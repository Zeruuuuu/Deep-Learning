...
class TestFCGeLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ...
            fc(input_dim=15, output_dim=5, name='fully_connected_layer1'),
            gelu(name='gelu')
            ########### END ###########
        )
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            fc(input_dim=4, output_dim=30, init_scale=0.02, name='fully1'),
            gelu(name='gelu'),
            fc(input_dim=30, output_dim=7, init_scale=0.02, name='fully2')
            ########### END ###########
        )
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        ...
        self.net = sequential(
            ########## TODO: ##########
            flatten(name='flatten'),
            fc(input_dim=3072, output_dim=500, init_scale=0.01, name='fully1'),
            gelu(name='gelu'),
            fc(input_dim=500, output_dim=20, init_scale=0.01, name='fully2')
            ########### END ###########
        )
